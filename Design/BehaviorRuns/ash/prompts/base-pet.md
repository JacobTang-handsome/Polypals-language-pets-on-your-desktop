Create one clean full-body reference sprite for Codex pet ash-behaviors.

Pet identity: Preserve the existing ash built-in pet identity exactly; generate only additional natural-life action strips..
