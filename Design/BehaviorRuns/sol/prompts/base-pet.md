Create one clean full-body reference sprite for Codex pet sol-behaviors.

Pet identity: Preserve the existing sol built-in pet identity exactly; generate only additional natural-life action strips..
