Create one clean full-body reference sprite for Codex pet mousse-behaviors.

Pet identity: Preserve the existing mousse built-in pet identity exactly; generate only additional natural-life action strips..
